...
import { fetchGroup, requestToJoinGroup } from "../../groups/api";
      ...
      <div className="group-detail__header">
        <div className="group-detail__top">
          ...
          <div className="group-detail__actions">
            {isOwnerOrModerator && (
              <Link className="btn-secondary" to={`/groups/${id}/admin`}>
                Admin panel
              </Link>
            )}
            ...
            {group.viewerMembershipStatus === MEMBERSHIP_STATUS.BANNED && (
              <span className="group-detail__status">You have been banned from this group</span>
            )}
          </div>
        </div>
